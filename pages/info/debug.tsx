...
// capabilities access
import { useCapabilityBrowserSpeechRecognition, useCapabilityPollinations, useCapabilityTextToImage } from '~/common/components/useCapabilities';
...
function AppDebug() {
  ...
  const cProduct = {
    capabilities: {
      ...
      pollinations: useCapabilityPollinations(),
